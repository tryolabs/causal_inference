...
def generateOneMetricMatrix(
    N, T, TrainingEnd, rowRank, colRank, genFunction, trueWeights, rowParams, colParams
):
...
def rankComparison():
    ...
    (
        ...
        meanTrainingDict,
        meanTestDict,
    ) = generateOneMetricMatrix(
        N, T, TrainingEnd, rowRank, colRank, genFunctionOne, trueWeights, rowParams, colParams
    )
    ...
    (
        ...
        N, T, TrainingEnd, rowRank, colRank, genFunctionTwo, trueWeights, rowParams, colParams
    )
...
def runAnalysis(N, T, TrainingEnd, rowRank, colRank):
    ...
    return {"rsc1": rscRMSE1, "rsc2": rscRMSE2, "mrsc1": mrscRMSE1, "mrsc2": mrscRMSE2}
